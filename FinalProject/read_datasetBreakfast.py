...
if __name__ == "__main__":
	COMP_PATH = '/Users/prodigy1026/Google Drive File Stream/My Drive/Colab Notebooks/cs5242project'
	# split = 'training'
	split = 'test'
	...
	if  split == 'training':
		...
		np.save("train.npy", data_feat)
		np.save("label.npy", data_labels)

	if  split == 'test':
		data_feat = load_data(test_split, actions_dict, GT_folder, DATA_folder, datatype = split)
		np.save("test.npy", data_feat)